...
class TestRectangle_area(unittest.TestCase):
    ...
    def test_area_small_ints(self):
        r = Rectangle(12, 11, 0, 1, 3)
        self.assertEqual(132, r.area())

    def test_area_large_ints(self):
        r = Rectangle(55551122223, 66677764433456767, 0, 1, 3)
        self.assertEqual(3704024641599359214003433041, r.area())
...
class TestRectangle_stdout(unittest.TestCase):
    ...
    def test_str_method_print_width_height(self):
        """Test __str__ method."""
        r = Rectangle(4, 6)
        capture = TestRectangle_stdout.return_text(r, "print")
    ...
    def test_display_width_height(self):
        ...
        capture = TestRectangle_stdout.return_text(r, "display")
        self.assertEqual("##\n##\n##\n", capture.getvalue())
...
class TestRectangle_update_args(unittest.TestCase):
    ...
    def test_update_args_str_width_type(self):
        r = Rectangle(10, 10, 10, 10, 10)
        with self.assertRaisesRegex(TypeError, "width must be an integer"):
            r.update(89, "invalid")
    ...
    def test_update_args_str_height_type(self):
        r = Rectangle(10, 10, 10, 10, 10)
        with self.assertRaisesRegex(TypeError, "height must be an integer"):
    ...
    def test_update_args_str_x_type(self):
        r = Rectangle(10, 10, 10, 10, 10)
        with self.assertRaisesRegex(TypeError, "x must be an integer"):
...
class TestRectangle_update_kwargs(unittest.TestCase):
    ...
    def test_update_kwargs_str_width_type(self):
        r = Rectangle(10, 10, 10, 10, 10)
        with self.assertRaisesRegex(TypeError, "width must be an integer"):
    ...
    def test_update_kwargs_str_height_type(self):
        r = Rectangle(10, 10, 10, 10, 10)
        with self.assertRaisesRegex(TypeError, "height must be an integer"):
    ...
    def test_update_kwargs_str_x_type(self):
        r = Rectangle(10, 10, 10, 10, 10)
        with self.assertRaisesRegex(TypeError, "x must be an integer"):
            r.update(x="invalid")
    ...
    def test_update_kwargs_str_y_type(self):
        r = Rectangle(10, 10, 10, 10, 10)
        with self.assertRaisesRegex(TypeError, "y must be an integer"):
            r.update(y="invalid")
...
class TestRectangle_to_dictionary(unittest.TestCase):
    ...
    def test_to_dictionary_output(self):
        r = Rectangle(6, 13, 5, 7, 3)
        expect = {'x': 5, 'y': 7, 'id': 3, 'height': 13, 'width': 6}
        self.assertDictEqual(expect, r.to_dictionary())
